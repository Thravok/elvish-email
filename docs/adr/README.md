...
| [0004](0004-per-field-metadata-consent.md) | Per-field metadata consent | Superseded by 0017 | Historical: per-field consent toggles (retired 2026-05). |
...
| [0014](0014-inbound-mail-authentication.md) | Inbound mail authentication (SPF, DKIM, DMARC) | Accepted (2026-05) | Verify sender auth on MX receive; log by default; optional quarantine/reject via env. |
...
| [0017](0017-full-server-metadata-policy.md) | Full server metadata for inbound mail | Accepted (2026-05) | Supersedes 0004 per-field consent; inbound SMTP metadata always persisted when parsed. |
| [0018](0018-console-service-and-support-escrow.md) | Console service and support key escrow | Proposed (2026-05) | Separate `elvishconsole` with staff RBAC; support-only key escrow for multi-staff inbox. |
