    ...
    <div className={`mail-shell no-topbar ${listSelection.focusId ? "detail-open" : ""}`}>
      ...
      {showSettings && window.ElvishMailSettings ? (
          ...
          {settingsEmbedStatus === "error" ? (
            <div style={{ padding: 24, maxWidth: 520 }}>
              ...
              <p className="mail-msg-body" style={{ marginBottom: 0 }}>
                Please reload the page. If the problem persists, confirm <code className="mono">mail-settings-lazy.js</code> was built (<code className="mono">make static-js</code>).
              </p>
              <button
                type="button"
                className="btn-sm"
        ...
        <main className="mail-admin-host mail-admin-embed-loading">
          <FullScreenStatus message="Opening operator console…" />
        </main>
      ) : !hasMail ? (
        <main className="mail-unavailable">
          <span className="icon">⚠</span>
          <h2>Mail subsystem unavailable</h2>
          <p>The server returned 503. ScyllaDB or object storage is probably not configured. Check elvishapi logs.</p>
