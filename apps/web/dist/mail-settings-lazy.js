(() => {
  ...
  // ../../../packages/elvish-ui/src/index.jsx
  var init_src = __esm({
    "../../../packages/elvish-ui/src/index.jsx"() {
      init_icons();
      init_primitives();
  ...
  function SMTPSubmissionSection({ onGoToIdentities }) {
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { className: "settings-section" }, /* @__PURE__ */ react_global_default.createElement("div", { className: "settings-section-header" }, /* @__PURE__ */ react_global_default.createElement("h2", null, "SMTP submission"), /* @__PURE__ */ react_global_default.createElement("p", null, "Connect Apple Mail, Thunderbird, Outlook, or any client that supports authenticated SMTP.")), !paid ? /* @__PURE__ */ react_global_default.createElement(Alert, { type: "info", title: "Paid feature" }, "SMTP submission requires paid API access (enable in Admin \u2192 Platform).") : null, error && /* @__PURE__ */ react_global_default.createElement(Alert, { type: "error" }, error), /* @__PURE__ */ react_global_default.createElement(
      Card,
      {
