(() => {
  ...
  function LoginPage() {
    ...
    const [rememberTrustedDevice, setRememberTrustedDevice] = useState2(false);
    ...
    const [mfaMethod, setMfaMethod] = useState2("totp");
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "auth-card" }, /* @__PURE__ */ React.createElement("div", { className: "auth-card-h" }, /* @__PURE__ */ React.createElement("span", { className: "kind" }, "AUTH"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, "session \xB7 valkey")), /* @__PURE__ */ React.createElement("div", { className: "auth-card-body" }, /* @__PURE__ */ React.createElement("h1", null, "Log in"), /* @__PURE__ */ React.createElement("p", { className: "lead" }, "Sign in with your username and password for ", /* @__PURE__ */ React.createElement("strong", null, "@", mailDomain || "\u2026"), ". Authentication uses ", /* @__PURE__ */ React.createElement("strong", null, "SRP"), ", so your password never goes over the wire, and the session cookie remains HTTP-only."), phase !== "mfa" && phase !== "mfa_loading" && /* @__PURE__ */ React.createElement("form", { onSubmit: submitPrimaryLogin }, /* @__PURE__ */ React.createElement("div", { className: "auth-field" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "username" }, "Username"), /* @__PURE__ */ React.createElement("input", { id: "username", type: "text", autoComplete: "username", value: username, onChange: (e) => setUsername(e.target.value), disabled: phase === "loading" })), /* @__PURE__ */ React.createElement("div", { className: "auth-field" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "password" }, "Password"), /* @__PURE__ */ React.createElement("input", { id: "password", type: "password", autoComplete: "current-password", value: password, onChange: (e) => setPassword(e.target.value), disabled: phase === "loading" })), /* @__PURE__ */ React.createElement("div", { className: "auth-field auth-inline-check-row" }, /* @__PURE__ */ React.createElement("label", { className: "auth-inline-check" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "checkbox",
    ...
    ), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("strong", null, "Trusted device"), " ", "\u2014 keep mailbox crypto keys in memory longer on this browser (about 14 days of inactivity, matching your session). Still cleared when you log out."))), CapField && capWidgetURL ? /* @__PURE__ */ React.createElement("div", { className: "auth-field" }, /* @__PURE__ */ React.createElement("label", null, "Human verification"), /* @__PURE__ */ React.createElement(CapField, { widgetApiEndpoint: capWidgetURL, onTokenChange: setCapToken })) : null, /* @__PURE__ */ React.createElement("div", { className: "auth-status " + (msg && phase !== "ok" ? "err" : phase === "ok" ? "ok" : "") }, msg), /* @__PURE__ */ React.createElement("div", { className: "auth-actions" }, /* @__PURE__ */ React.createElement("button", { type: "submit", className: "btn-sm primary", disabled: phase === "loading" }, phase === "loading" ? "\u2026" : "\u25B8 LOGIN"), /* @__PURE__ */ React.createElement("a", { className: "btn-sm", href: nextOk ? `/register?next=${encodeURIComponent(nextOk)}` : "/register" }, "Create account"))), (phase === "mfa" || phase === "mfa_loading") && /* @__PURE__ */ React.createElement("form", { onSubmit: submitCode }, /* @__PURE__ */ React.createElement("p", { className: "lead" }, "Confirm your sign-in for ", /* @__PURE__ */ React.createElement("strong", null, challenge && challenge.user && challenge.user.email ? challenge.user.email : username ? `${username}@${mailDomain || "\u2026"}` : "your account"), "."), challenge && Array.isArray(challenge.methods) && challenge.methods.length > 1 && /* @__PURE__ */ React.createElement("div", { className: "auth-actions", style: { marginBottom: 12 } }, challenge.methods.includes("totp") && /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn-sm " + (mfaMethod === "totp" ? "primary" : ""), onClick: () => setMfaMethod("totp"), disabled: phase === "mfa_loading" }, "Authenticator app"), challenge.methods.includes("recovery") && /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn-sm " + (mfaMethod === "recovery" ? "primary" : ""), onClick: () => setMfaMethod("recovery"), disabled: phase === "mfa_loading" }, "Recovery code"), challenge.methods.includes("webauthn") && /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn-sm", onClick: useSecurityKey, disabled: phase === "mfa_loading" }, "Use security key")), (mfaMethod === "totp" || mfaMethod === "recovery") && /* @__PURE__ */ React.createElement("div", { className: "auth-field" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "mfa-code" }, mfaMethod === "recovery" ? "Recovery code" : "Authenticator code"), /* @__PURE__ */ React.createElement(
      "input",
      {
        id: "mfa-code",
        type: "text",
    ...
    )), challenge && challenge.methods && challenge.methods.includes("webauthn") && challenge.methods.length === 1 && /* @__PURE__ */ React.createElement("div", { className: "auth-actions", style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn-sm primary", onClick: useSecurityKey, disabled: phase === "mfa_loading" }, "Use security key")), /* @__PURE__ */ React.createElement("div", { className: "auth-status " + (msg ? "err" : "") }, msg), /* @__PURE__ */ React.createElement("div", { className: "auth-actions" }, (mfaMethod === "totp" || mfaMethod === "recovery") && /* @__PURE__ */ React.createElement("button", { type: "submit", className: "btn-sm primary", disabled: phase === "mfa_loading" }, phase === "mfa_loading" ? "\u2026" : "\u25B8 VERIFY"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn-sm", onClick: () => {
      setPhase("idle");
      setChallenge(null);
      setMsg("");
    }, disabled: phase === "mfa_loading" }, "Back"))))));
  }
  ...
  var init_auth_login = __esm({
    "../auth/auth-login.jsx"() {
      ...
      if (root) ReactDOM.createRoot(root).render(/* @__PURE__ */ React.createElement(LoginPage, null));
    }
  });

  // entries/auth-login-entry.jsx
  var require_auth_login_entry = __commonJS({
    "entries/auth-login-entry.jsx"() {
