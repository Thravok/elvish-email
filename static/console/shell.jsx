...
function Topbar({ active }) {
  ...
  if (active === "home" || active === "tools") {
    ...
    centerAfterNav = <a href="/console/" className="navlink active" aria-current="page">PANEL</a>;
  } else if (active === "log") {
      ...
      authContent={({ me, loggedIn, label }) => {
        ...
        return (
          <>
            ...
            {me.is_admin && active !== "admin" && <a href="/console/" className="navlink">PANEL</a>}
