...
\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518`), /* @__PURE__ */ React.createElement("div", { className: "dim", style: { marginTop: 10, fontSize: 10 } }, "// END OF FILE")));
      ...
      ENTRIES = [
        {
          ...
          body: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "This is the default entry. Replace it with your own posts under ", /* @__PURE__ */ React.createElement("code", null, "content/blog/"), " (or publish via the API when MongoDB is configured). Detached OpenPGP signatures are optional but supported.")),
          tags: ["notes"],
          bytes: "1KB",
          reach: "\u2014"
        }
  ...
  function BlogApp() {
    ...
    const entries2 = window.ENTRIES || [];
    const filtered = filter === "all" ? entries2 : entries2.filter((e) => e.tags.includes(filter));
    const FILTERS = [
      { id: "all", label: "ALL" },
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, tweak.showGrid && /* @__PURE__ */ React.createElement("div", { className: "bg-grid" }), tweak.scanlines && /* @__PURE__ */ React.createElement("div", { className: "scanline" }), /* @__PURE__ */ React.createElement("div", { className: "crosshair" }), /* @__PURE__ */ React.createElement("div", { className: "frame" }, /* @__PURE__ */ React.createElement(window.Topbar, { active: "log" }), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, marginBottom: 4, fontSize: 10, letterSpacing: "0.18em", color: "var(--dim)", textTransform: "uppercase", textAlign: "right" } }, /* @__PURE__ */ React.createElement("a", { href: "/login", style: { color: "var(--accent)" } }, "log in"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, " \xB7 "), /* @__PURE__ */ React.createElement("a", { href: "/register", style: { color: "var(--accent)" } }, "register"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, " \xB7 "), /* @__PURE__ */ React.createElement("a", { href: "/admin/", style: { color: "var(--accent)" } }, "panel")), /* @__PURE__ */ React.createElement("section", { className: "manifesto" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "section-label" }, /* @__PURE__ */ React.createElement("span", { className: "index" }, "\xA7 LOG"), " CHRONOLOGY ", /* @__PURE__ */ React.createElement("span", { className: "rule" })), /* @__PURE__ */ React.createElement("h1", { style: { marginTop: 18 } }, "THE ", /* @__PURE__ */ React.createElement("span", { className: "stripe" }, "LOG"), /* @__PURE__ */ React.createElement("br", null), "IS THE PRODUCT", /* @__PURE__ */ React.createElement("br", null), "CHANGELOG."), /* @__PURE__ */ React.createElement("p", null, "Releases, audit notes, the occasional essay. Nothing scheduled. No newsletter. Bookmark or scrape; both are blessed."), /* @__PURE__ */ React.createElement("p", { style: { marginTop: 8, color: "var(--accent)" } }, "// reverse-chronological. tail -f the world.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "bracket", style: { padding: 14, position: "relative" } }, /* @__PURE__ */ React.createElement("span", { className: "br-bl" }), /* @__PURE__ */ React.createElement("span", { className: "br-br" }), /* @__PURE__ */ React.createElement("div", { className: "ftk", style: { fontSize: 10, letterSpacing: "0.2em", color: "var(--dim)", marginBottom: 8 } }, "// FEED"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6, fontSize: 11 } }, /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "RSS"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "/feed.xml")), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "JSON"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "/feed.json")), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "ATOM"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "/atom.xml")), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "SIGNED"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("a", { href: "/pgp/keys.json", style: { color: "var(--accent)" } }, "/pgp/keys.json"))))), /* @__PURE__ */ React.createElement("div", { className: "bracket", style: { padding: 14, position: "relative" } }, /* @__PURE__ */ React.createElement("span", { className: "br-bl" }), /* @__PURE__ */ React.createElement("span", { className: "br-br" }), /* @__PURE__ */ React.createElement("div", { className: "ftk", style: { fontSize: 10, letterSpacing: "0.2em", color: "var(--dim)", marginBottom: 8 } }, "// COUNTS"), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between", padding: "3px 0" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "ENTRIES"), /* @__PURE__ */ React.createElement("span", null, entries2.length)), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between", padding: "3px 0" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "FIRST"), /* @__PURE__ */ React.createElement("span", null, "26.01.05")), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between", padding: "3px 0" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "LATEST"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "26.04.28")), /* @__PURE__ */ React.createElement("div", { className: "row", style: { justifyContent: "space-between", padding: "3px 0" } }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "CADENCE"), /* @__PURE__ */ React.createElement("span", null, "WHEN-READY"))))), /* @__PURE__ */ React.createElement("div", { className: "cl-filterbar" }, /* @__PURE__ */ React.createElement("span", { className: "tiny dim" }, "FILTER \u25B8"), FILTERS.map((f) => /* @__PURE__ */ React.createElement(
      "span",
      {
        key: f.id,
      ...
      f.label
    )), /* @__PURE__ */ React.createElement("span", { className: "tiny dim", style: { marginLeft: "auto" } }, filtered.length, " / ", entries2.length, " ENTRIES")), /* @__PURE__ */ React.createElement("div", { className: "changelog" }, /* @__PURE__ */ React.createElement("div", { className: "cl-head" }, /* @__PURE__ */ React.createElement("span", null, "DATE"), /* @__PURE__ */ React.createElement("span", null, "ENTRY"), /* @__PURE__ */ React.createElement("span", null, "BYTES \xB7 REACH")), filtered.map((e, i) => /* @__PURE__ */ React.createElement("article", { key: i, className: "cl-entry" }, /* @__PURE__ */ React.createElement("div", { className: "cl-date" }, /* @__PURE__ */ React.createElement("span", { className: "y" }, e.date), /* @__PURE__ */ React.createElement("span", { className: "t" }, e.time, " UTC")), /* @__PURE__ */ React.createElement("div", { className: "cl-body" }, /* @__PURE__ */ React.createElement("div", { className: "cl-tagrow" }, e.tags.map((t) => /* @__PURE__ */ React.createElement("span", { key: t, className: "cl-tag " + t }, t))), /* @__PURE__ */ React.createElement("h2", { className: "cl-title" }, e.title), /* @__PURE__ */ React.createElement("div", { className: "cl-prose" }, e.body), /* @__PURE__ */ React.createElement("div", { className: "cl-meta" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "k" }, "\u25B8"), "BYTES \xB7 ", e.bytes), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "k" }, "\u25B8"), "REACH \xB7 ", e.reach), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "k" }, "\u25B8"), "PERMALINK \xB7 /log/", e.date)))))), /* @__PURE__ */ React.createElement("div", { className: "stripe-band" }), /* @__PURE__ */ React.createElement("div", { className: "ticker", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "ticker-track" }, /* @__PURE__ */ React.createElement("span", null, "END OF LOG"), /* @__PURE__ */ React.createElement("span", null, "NO COMMENTS"), /* @__PURE__ */ React.createElement("span", null, "NO TRACKERS"), /* @__PURE__ */ React.createElement("span", null, "NO PAYWALL"), /* @__PURE__ */ React.createElement("span", null, "SUBSCRIBE VIA RSS OR DON'T"), /* @__PURE__ */ React.createElement("span", null, "I'M NOT KEEPING SCORE"), /* @__PURE__ */ React.createElement("span", null, "END OF LOG"), /* @__PURE__ */ React.createElement("span", null, "NO COMMENTS"), /* @__PURE__ */ React.createElement("span", null, "NO TRACKERS"), /* @__PURE__ */ React.createElement("span", null, "NO PAYWALL"), /* @__PURE__ */ React.createElement("span", null, "SUBSCRIBE VIA RSS OR DON'T"), /* @__PURE__ */ React.createElement("span", null, "I'M NOT KEEPING SCORE"))), /* @__PURE__ */ React.createElement(Footer, null), /* @__PURE__ */ React.createElement(window.TweaksPanel, { title: "TWEAKS" }, /* @__PURE__ */ React.createElement(window.TweakSection, { title: "Appearance" }, /* @__PURE__ */ React.createElement(
      window.TweakRadio,
      {
        label: "Theme",
        value: tweak.theme,
  ...
  var useS_b, useE_b;
  var init_app_blog = __esm({
    "../static/admin/app-blog.jsx"() {
      ({ useState: useS_b, useEffect: useE_b } = React);
      ReactDOM.createRoot(document.getElementById("root")).render(/* @__PURE__ */ React.createElement(BlogApp, null));
    }
  });

  // entries/admin-blog-entry.jsx
  var require_admin_blog_entry = __commonJS({
    "entries/admin-blog-entry.jsx"() {
