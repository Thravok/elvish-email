...
\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518`), /* @__PURE__ */ React.createElement("div", { className: "dim", style: { marginTop: 10, fontSize: 10 } }, "// END OF FILE")));
  ...
  function CommandPaletteModal({ open, onClose, commands, onRun }) {
    ...
    return /* @__PURE__ */ React.createElement(Modal, { open, onClose, title: "COMMAND PALETTE", kind: "CMDP", status: `${filtered.length}/${commands.length}` }, /* @__PURE__ */ React.createElement("div", { className: "cmdp" }, /* @__PURE__ */ React.createElement(
      "input",
      {
  ...
  function SigningKeyModal({ open, onClose, onUpload }) {
    ...
    const onFile = (f) => {
      ...
      reader.onload = () => {
        ...
        if (/BEGIN PGP PRIVATE KEY/i.test(text2) || /BEGIN PRIVATE KEY/i.test(text2)) {
          setErrDetail("refused: private key material");
          setFile(null);
          return;
        }
        setArmored(text2);
        const m = text2.match(/([A-F0-9]{16})\s*$/im);
  ...
  function AboutModal({ open, onClose, site }) {
    return /* @__PURE__ */ React.createElement(Modal, { open, onClose, title: "ABOUT \xB7 ELVISH", kind: "META", status: "v0.7.4-NIGHTLY", size: "narrow" }, /* @__PURE__ */ React.createElement("div", { className: "about-block" }, /* @__PURE__ */ React.createElement("div", { className: "ascii" }, `\u2588\u2580\u2584 \u2588\u2580\u2580 \u2588\u2580\u2588 \u2588\u2580\u2588 \u2584\u2580\u2588 \u2588\u2580\u2588
\u2588\u2580  \u2588\u2588\u2584 \u2588\u2584\u2588 \u2588\u2580\u2580 \u2588\u2580\u2588 \u2588\u2580\u2584
  ...
  function GalleryApp() {
    ...
    const COMMANDS = [
      ...
      { id: "goto.tools", name: "Goto \xB7 Tools", scope: "ADMIN", glyph: "\u25B8", shortcut: "g t" },
      { id: "goto.posts", name: "Goto \xB7 Blog posts", scope: "ADMIN", glyph: "\u25B8", shortcut: "g p" },
    ...
    const DIFF = [
      { kind: "mod", scope: "site", path: "content/home.json \xB7 site.title" },
      { kind: "mod", scope: "site", path: "content/home.json \xB7 site.description" },
      { kind: "add", scope: "tools", path: "content/home.json \xB7 tools[12] (echo)" },
      { kind: "mod", scope: "tools", path: "content/home.json \xB7 tools[3].desc" },
      ...
      { kind: "mod", scope: "metrics", path: "content/blog/metrics.json \xB7 against-the-dashboard" },
      { kind: "mod", scope: "log", path: "content/home.json \xB7 log_page.intro_markdown" }
    ];
    const M = window.VModals;
    const cards = [
      { id: "preview", t: "Tool Preview", d: "Read-only spec card for a tool." },
      { id: "confirm", t: "Confirm \xB7 Destroy", d: "Type-to-confirm destructive action." },
      ...
      { id: "publish", t: "Publish \xB7 Diff", d: "Review changes before saving to the live API." },
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, tweak.showGrid && /* @__PURE__ */ React.createElement("div", { className: "bg-grid" }), /* @__PURE__ */ React.createElement("div", { className: "frame" }, /* @__PURE__ */ React.createElement(window.Topbar, { active: "modals" }), /* @__PURE__ */ React.createElement("section", { className: "manifesto" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "section-label" }, /* @__PURE__ */ React.createElement("span", { className: "index" }, "\xA7 MOD"), " SYSTEM ", /* @__PURE__ */ React.createElement("span", { className: "rule" })), /* @__PURE__ */ React.createElement("h1", { style: { marginTop: 18 } }, "MODAL ", /* @__PURE__ */ React.createElement("span", { className: "stripe" }, "SET"), /* @__PURE__ */ React.createElement("br", null), "FOR THE WHOLE", /* @__PURE__ */ React.createElement("br", null), "SURFACE."), /* @__PURE__ */ React.createElement("p", null, "Nine modals tuned to actual ELVISH flows: previewing tools, destructive confirm, \u2318K palette, shortcut help, sudo, commit-PR with diff, signing-key upload, about card, notify."), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--accent)", marginTop: 8 } }, "// click any tile \xB7 esc to close \xB7 \u2318K from anywhere")), /* @__PURE__ */ React.createElement("div", { className: "bracket", style: { padding: 14, position: "relative" } }, /* @__PURE__ */ React.createElement("span", { className: "br-bl" }), /* @__PURE__ */ React.createElement("span", { className: "br-br" }), /* @__PURE__ */ React.createElement("div", { className: "ftk", style: { fontSize: 10, letterSpacing: "0.2em", color: "var(--dim)", marginBottom: 8 } }, "// SHARED CHROME"), /* @__PURE__ */ React.createElement("ul", { style: { listStyle: "none", display: "flex", flexDirection: "column", gap: 6, fontSize: 11 } }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u25B8"), " Corner brackets \xB7 accent"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u25B8"), " 4-cell title bar (kind \xB7 title \xB7 status \xB7 \xD7)"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u25B8"), " Backdrop with fine grid overlay"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u25B8"), " Drop-shadow at 16/16 in accent @ 18%"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u25B8"), " Esc dismiss \xB7 click-outside dismiss"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u25B8"), " Foot bar with helper kbd hints")))), /* @__PURE__ */ React.createElement("div", { className: "tools-grid", style: { borderTop: "1px solid var(--fg)" } }, cards.map((c, i) => /* @__PURE__ */ React.createElement("article", { key: c.id, className: "tool-card active", onClick: () => setOpenId(c.id), style: { cursor: "pointer" } }, /* @__PURE__ */ React.createElement("span", { className: "cb tl" }), /* @__PURE__ */ React.createElement("span", { className: "cb tr" }), /* @__PURE__ */ React.createElement("span", { className: "cb bl" }), /* @__PURE__ */ React.createElement("span", { className: "cb br" }), /* @__PURE__ */ React.createElement("header", { className: "tc-head" }, /* @__PURE__ */ React.createElement("div", { className: "tc-head-l" }, /* @__PURE__ */ React.createElement("span", { className: "tc-id" }, String(i + 1).padStart(2, "0")), /* @__PURE__ */ React.createElement("span", { className: "tc-slash" }, "/"), /* @__PURE__ */ React.createElement("span", { className: "tc-name" }, c.t)), /* @__PURE__ */ React.createElement("span", { className: "tag live" }, "modal")), /* @__PURE__ */ React.createElement("div", { className: "tc-body" }, /* @__PURE__ */ React.createElement("p", { className: "tc-desc" }, c.d), /* @__PURE__ */ React.createElement("hr", null), /* @__PURE__ */ React.createElement("div", { className: "tc-foot" }, /* @__PURE__ */ React.createElement("span", { className: "dim tiny" }, "CLICK TO OPEN"), /* @__PURE__ */ React.createElement("span", { className: "tc-launch" }, /* @__PURE__ */ React.createElement("span", null, "SHOW"), /* @__PURE__ */ React.createElement("span", { className: "arr" }, "\u2192"))))))), /* @__PURE__ */ React.createElement("div", { className: "ticker", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "ticker-track" }, /* @__PURE__ */ React.createElement("span", null, "ESC TO CLOSE"), /* @__PURE__ */ React.createElement("span", null, "\u2318K \xB7 COMMAND PALETTE"), /* @__PURE__ */ React.createElement("span", null, "? \xB7 SHORTCUTS"), /* @__PURE__ */ React.createElement("span", null, "SIGNED BY ANON"), /* @__PURE__ */ React.createElement("span", null, "NO TRACKERS IN MODALS"), /* @__PURE__ */ React.createElement("span", null, "BRUTALIST"), /* @__PURE__ */ React.createElement("span", null, "ESC TO CLOSE"), /* @__PURE__ */ React.createElement("span", null, "\u2318K \xB7 COMMAND PALETTE"), /* @__PURE__ */ React.createElement("span", null, "? \xB7 SHORTCUTS"), /* @__PURE__ */ React.createElement("span", null, "SIGNED BY ANON"), /* @__PURE__ */ React.createElement("span", null, "NO TRACKERS IN MODALS"), /* @__PURE__ */ React.createElement("span", null, "BRUTALIST"))), /* @__PURE__ */ React.createElement(window.Footer, null), /* @__PURE__ */ React.createElement(window.TweaksPanel, { title: "TWEAKS" }, /* @__PURE__ */ React.createElement(window.TweakSection, { title: "Appearance" }, /* @__PURE__ */ React.createElement(
      window.TweakRadio,
      {
        label: "Theme",
        value: tweak.theme,
    ...
    ), /* @__PURE__ */ React.createElement(window.TweakSelect, { label: "Font", value: tweak.font, onChange: (v) => setTweak("font", v), options: window.TWEAK_FONT_OPTIONS }), /* @__PURE__ */ React.createElement(window.TweakToggle, { label: "Background grid", value: tweak.showGrid, onChange: (v) => setTweak("showGrid", v) })), /* @__PURE__ */ React.createElement(window.TweakSection, { title: "Open modal directly" }, cards.map((c) => /* @__PURE__ */ React.createElement(window.TweakButton, { key: c.id, label: c.t, onClick: () => setOpenId(c.id) }))))), /* @__PURE__ */ React.createElement(M.ToolPreviewModal, { open: openId === "preview", onClose: close, tool: SAMPLE_TOOL }), /* @__PURE__ */ React.createElement(
      M.ConfirmDestroyModal,
      {
        open: openId === "confirm",
        onClose: close,
        target: { name: "OBSCURA", path: "content/home.json \xB7 tools[10]", detail: "live tool \xB7 1.4M calls \xB7 removing will 410 the slug." },
        phrase: "DELETE",
      ...
      M.CommandPaletteModal,
      {
        ...
        onClose: close,
        commands: COMMANDS,
        onRun: (c) => setNotif({ kind: "ok", title: "Ran \xB7 " + c.name, body: "scope: " + c.scope })
      }
    ), /* @__PURE__ */ React.createElement(M.ShortcutsModal, { open: openId === "shortcuts", onClose: close }), /* @__PURE__ */ React.createElement(
      M.AuthModal,
      {
        open: openId === "auth",
        onClose: close,
    ...
    ), /* @__PURE__ */ React.createElement(M.AboutModal, { open: openId === "about", onClose: close, site: window.ADMIN_STATE_INITIAL.site }), /* @__PURE__ */ React.createElement(
      M.NotifyModal,
      {
        open: openId === "notify",
        onClose: close,
        ...
        body: "You have unsaved edits. Publish saves to the live API when wired, or discard from /admin."
      }
    ), /* @__PURE__ */ React.createElement(M.NotifyModal, { open: !!notif, onClose: () => setNotif(null), kind: notif?.kind, title: notif?.title, body: notif?.body }));
  }
  var useS_g;
  var init_app_modals = __esm({
    "../static/admin/app-modals.jsx"() {
      ({ useState: useS_g } = React);
      ReactDOM.createRoot(document.getElementById("root")).render(/* @__PURE__ */ React.createElement(GalleryApp, null));
    }
  });

  // entries/admin-modals-entry.jsx
  var require_admin_modals_entry = __commonJS({
    "entries/admin-modals-entry.jsx"() {
