...
`;
  ...
  var import_react, useState, useEffect;
  var init_public_topbar = __esm({
    "../static/site/public-topbar.jsx"() {
      import_react = __toESM(require_react());
      ({ useState, useEffect } = import_react.default);
...
\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518`), /* @__PURE__ */ React.createElement("div", { className: "dim", style: { marginTop: 10, fontSize: 10 } }, "// END OF FILE")));
  ...
  var init_shell = __esm({
    "../static/admin/shell.jsx"() {
      ...
      window.Footer = Footer2;
    }
  });

  // ../static/admin/terminal.jsx
  ...
  function Terminal2({ onComplete }) {
    ...
    const renderLine = (l, i) => {
      if (l.kind === "blank") return /* @__PURE__ */ React.createElement("div", { key: i, style: { height: "1.4em" } }, "\xA0");
      if (l.kind === "sys" || l.kind === "prompt") {
        return /* @__PURE__ */ React.createElement("div", { key: i }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, l.text.split("$")[0], "$"), /* @__PURE__ */ React.createElement("span", null, l.text.split("$")[1]));
      }
      if (l.kind === "log") {
      ...
      if (l.kind === "head") return /* @__PURE__ */ React.createElement("div", { key: i, style: { color: "var(--fg)", fontWeight: 700, letterSpacing: "0.04em" } }, l.text);
      return /* @__PURE__ */ React.createElement("div", { key: i }, l.text);
    };
    return /* @__PURE__ */ React.createElement("div", { className: "terminal" }, /* @__PURE__ */ React.createElement("div", { className: "terminal-bar" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u250C\u2500"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "\u25CF "), /* @__PURE__ */ React.createElement("span", null, "ELVISH \xB7 /BIN/SH"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u2500 80\xD724 \u2500"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, "PID 0x4F2A \u2500\u2510")), /* @__PURE__ */ React.createElement("div", { className: "terminal-body" }, lines.map(renderLine), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "elvish:~$"), " ", /* @__PURE__ */ React.createElement("span", { className: "cursor" }, "\u2588"))));
  }
  var useState2, useEffect2, useRef;
  var init_terminal = __esm({
    "../static/admin/terminal.jsx"() {
      ({ useState: useState2, useEffect: useEffect2, useRef } = React);
      window.Terminal = Terminal2;
    }
  });

  // ../static/admin/tools-data.jsx
  function Glyph2({ name, animated = false }) {
  ...
  function ToolCard({ tool, index, focused, onFocus, onOpen, callLabel }) {
    ...
    return /* @__PURE__ */ React.createElement(
      "article",
      {
        ...
        onKeyDown: (e) => {
          if (e.key === "Enter") onOpen && onOpen(tool);
        }
      },
      /* @__PURE__ */ React.createElement("span", { className: "cb tl" }),
      /* @__PURE__ */ React.createElement("span", { className: "cb tr" }),
      /* @__PURE__ */ React.createElement("span", { className: "cb bl" }),
      /* @__PURE__ */ React.createElement("span", { className: "cb br" }),
      /* @__PURE__ */ React.createElement("header", { className: "tc-head" }, /* @__PURE__ */ React.createElement("div", { className: "tc-head-l" }, /* @__PURE__ */ React.createElement("span", { className: "tc-id" }, tool.id), /* @__PURE__ */ React.createElement("span", { className: "tc-slash" }, "/"), /* @__PURE__ */ React.createElement("span", { className: "tc-name" }, tool.name)), /* @__PURE__ */ React.createElement("span", { className: "tag " + tool.tag }, tool.tag)),
      /* @__PURE__ */ React.createElement("div", { className: "tc-body" }, /* @__PURE__ */ React.createElement("div", { className: "tc-glyph" }, /* @__PURE__ */ React.createElement(Glyph, { name: tool.glyph }), /* @__PURE__ */ React.createElement("div", { className: "tc-glyph-overlay" }, /* @__PURE__ */ React.createElement("div", { className: "ovl-line", style: { animationDelay: "0ms" } }), /* @__PURE__ */ React.createElement("div", { className: "ovl-line", style: { animationDelay: "60ms" } }), /* @__PURE__ */ React.createElement("div", { className: "ovl-line", style: { animationDelay: "120ms" } }), /* @__PURE__ */ React.createElement("div", { className: "ovl-line", style: { animationDelay: "180ms" } })), /* @__PURE__ */ React.createElement("div", { className: "tc-coords" }, /* @__PURE__ */ React.createElement("span", null, "x:", tool.id), /* @__PURE__ */ React.createElement("span", null, "y:", tool.since))), /* @__PURE__ */ React.createElement("p", { className: "tc-desc" }, tool.desc), /* @__PURE__ */ React.createElement("div", { className: "tc-stack" }, (tool.signals ?? tool.stack ?? []).map((s) => /* @__PURE__ */ React.createElement("span", { key: s, className: "stack-chip" }, s))), /* @__PURE__ */ React.createElement("hr", null), /* @__PURE__ */ React.createElement("div", { className: "tc-foot" }, /* @__PURE__ */ React.createElement("span", { className: "dim tiny" }, "CALLS \xB7 ", callLabel), /* @__PURE__ */ React.createElement("span", { className: "tc-launch" }, /* @__PURE__ */ React.createElement("span", null, "OPEN"), /* @__PURE__ */ React.createElement("span", { className: "arr" }, "\u2192"))))
    );
  }
  function ToolsGrid({ query }) {
    ...
    const filtered = TOOLS.filter((t) => {
      ...
      if (!q) return true;
      return t.name && t.name.toLowerCase().includes(q) || t.slug && t.slug.toLowerCase().includes(q) || t.desc && t.desc.toLowerCase().includes(q) || (t.signals ?? t.stack ?? []).join(" ").toLowerCase().includes(q);
    });
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "tools-grid" }, filtered.map((t, i) => /* @__PURE__ */ React.createElement(
      ToolCard,
      {
        key: t.id,
        tool: t,
        ...
        onFocus: setFocusIdx,
        onOpen: handleOpen,
        callLabel: callLabelFor(t)
      }
    )), filtered.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "dim tiny" }, "// no match"), /* @__PURE__ */ React.createElement("div", { className: "display", style: { fontSize: 40, marginTop: 8 } }, "404 / VOID")));
  }
  var useState_tg, useEffect_tg, useRef_tg, useCallback_tg;
  var init_tools_grid = __esm({
    "../static/admin/tools-grid.jsx"() {
      ({ useState: useState_tg, useEffect: useEffect_tg, useRef: useRef_tg, useCallback: useCallback_tg } = React);
      window.ToolsGrid = ToolsGrid;
      window.ToolCard = ToolCard;
    }
  });

  // ../static/admin/app-index.jsx
  function App() {
      ...
      const onKey = (e) => {
        ...
        if (k === seq[pos]) {
          ...
          if (pos === seq.length) {
            ...
            setTimeout(() => setKonami(false), 4e3);
          }
        } else {
          pos = k === seq[0] ? 1 : 0;
        }
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, tweak.showGrid && /* @__PURE__ */ React.createElement("div", { className: "bg-grid" }), tweak.scanlines && /* @__PURE__ */ React.createElement("div", { className: "scanline" }), /* @__PURE__ */ React.createElement("div", { className: "crosshair" }), /* @__PURE__ */ React.createElement("div", { className: "frame" }, /* @__PURE__ */ React.createElement(window.Topbar, { active: "home" }), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, marginBottom: 4, fontSize: 10, letterSpacing: "0.18em", color: "var(--dim)", textTransform: "uppercase", textAlign: "right" } }, /* @__PURE__ */ React.createElement("a", { href: "/login", style: { color: "var(--accent)" } }, "log in"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, " \xB7 "), /* @__PURE__ */ React.createElement("a", { href: "/register", style: { color: "var(--accent)" } }, "register"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, " \xB7 "), /* @__PURE__ */ React.createElement("a", { href: "/admin/", style: { color: "var(--accent)" } }, "panel")), /* @__PURE__ */ React.createElement(Terminal, null), /* @__PURE__ */ React.createElement("section", { className: "hero" }, /* @__PURE__ */ React.createElement("div", { className: "hero-l" }, /* @__PURE__ */ React.createElement("div", { className: "section-label" }, /* @__PURE__ */ React.createElement("span", { className: "index" }, "\xA7 00"), " E2EE MAIL ", /* @__PURE__ */ React.createElement("span", { className: "rule" })), /* @__PURE__ */ React.createElement("h1", { className: "display", style: { marginTop: 18 } }, /* @__PURE__ */ React.createElement("span", { className: "stripe" }, "END-TO-END"), " ENCRYPTED", /* @__PURE__ */ React.createElement("br", null), "MAIL.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { className: "stripe" }, "ZERO-ACCESS"), " DELIVERY."), /* @__PURE__ */ React.createElement("p", { className: "lede" }, /* @__PURE__ */ React.createElement("strong", null, "ELVISH"), " is an end-to-end encrypted mail platform. Messages are encrypted in your browser before storage or delivery. Use OpenPGP inboxes, protected links, or relay mode without giving the server your plaintext. ", /* @__PURE__ */ React.createElement("span", { className: "dim" }, "// zero-access by design")), /* @__PURE__ */ React.createElement("div", { className: "hero-meta" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "ENCRYPTION"), /* @__PURE__ */ React.createElement("div", { className: "v" }, "OPENPGP")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "KEYS"), /* @__PURE__ */ React.createElement("div", { className: "v" }, "BROWSER-HELD")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "DELIVERY"), /* @__PURE__ */ React.createElement("div", { className: "v" }, "SMTP + LINK")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "STORAGE"), /* @__PURE__ */ React.createElement("div", { className: "v" }, "CIPHERTEXT")))), /* @__PURE__ */ React.createElement("div", { className: "hero-r" }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("h4", null, "// MAIL FLOW"), /* @__PURE__ */ React.createElement("div", { className: "home-flow" }, /* @__PURE__ */ React.createElement("div", { className: "home-flow-step" }, /* @__PURE__ */ React.createElement("div", { className: "home-flow-index" }, "01"), /* @__PURE__ */ React.createElement("div", { className: "home-flow-copy" }, /* @__PURE__ */ React.createElement("strong", null, "Compose and encrypt in the browser"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, "Keys unlock locally, then message bodies are encrypted before they ever hit storage."))), /* @__PURE__ */ React.createElement("div", { className: "home-flow-step" }, /* @__PURE__ */ React.createElement("div", { className: "home-flow-index" }, "02"), /* @__PURE__ */ React.createElement("div", { className: "home-flow-copy" }, /* @__PURE__ */ React.createElement("strong", null, "Store ciphertext, not plaintext"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, "The operator sees encrypted blobs, wrapped key material, and delivery metadata only."))), /* @__PURE__ */ React.createElement("div", { className: "home-flow-step" }, /* @__PURE__ */ React.createElement("div", { className: "home-flow-index" }, "03"), /* @__PURE__ */ React.createElement("div", { className: "home-flow-copy" }, /* @__PURE__ */ React.createElement("strong", null, "Decrypt where the recipient opens"), /* @__PURE__ */ React.createElement("span", { className: "dim" }, "OpenPGP recipients decrypt with their keys; protected links unlock client-side with a shared secret."))))), /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("h4", null, "// THREAT MODEL"), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "SERVER"), /* @__PURE__ */ React.createElement("span", null, "CIPHERTEXT ONLY")), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "PRIVATE KEYS"), /* @__PURE__ */ React.createElement("span", null, "LOCAL ONLY")), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "SEARCH"), /* @__PURE__ */ React.createElement("span", null, "LOCAL BODY INDEX")), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "PORTABILITY"), /* @__PURE__ */ React.createElement("span", null, "OPENPGP EXPORT"))), /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("h4", null, "// SEND MODES"), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "MODE A"), /* @__PURE__ */ React.createElement("span", null, "PGP DIRECT")), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "MODE B"), /* @__PURE__ */ React.createElement("span", null, "PROTECTED LINK")), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "MODE C"), /* @__PURE__ */ React.createElement("span", null, "PLAINTEXT RELAY")), /* @__PURE__ */ React.createElement("div", { className: "row home-kv" }, /* @__PURE__ */ React.createElement("span", { className: "dim" }, "DELIVERY"), /* @__PURE__ */ React.createElement("span", null, "SMTP + CUSTOM DOMAINS"))))), /* @__PURE__ */ React.createElement("div", { className: "section-label home-section-label" }, /* @__PURE__ */ React.createElement("span", { className: "index" }, "// 01"), " DELIVERY ", /* @__PURE__ */ React.createElement("span", { className: "rule" }), /* @__PURE__ */ React.createElement("span", { className: "tiny dim" }, "THREE WAYS TO SEND SECURELY")), /* @__PURE__ */ React.createElement("div", { className: "home-card-grid" }, /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// OPENPGP DIRECT"), /* @__PURE__ */ React.createElement("p", null, "Encrypt directly to a recipient's published key and keep the message protected across the full route."), /* @__PURE__ */ React.createElement("div", { className: "tiny dim" }, "BEST FOR \xB7 PGP USERS \xB7 STANDARD MAIL CLIENTS")), /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// PROTECTED LINKS"), /* @__PURE__ */ React.createElement("p", null, "Wrap the body under a sender-chosen password and deliver an unlock link. The password never reaches the server."), /* @__PURE__ */ React.createElement("div", { className: "tiny dim" }, "BEST FOR \xB7 ANY RECIPIENT \xB7 CLIENT-SIDE UNLOCK")), /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// RELAY MODE"), /* @__PURE__ */ React.createElement("p", null, "When plaintext delivery is unavoidable, persist only relay-key-wrapped ciphertext and decrypt only in memory at send time."), /* @__PURE__ */ React.createElement("div", { className: "tiny dim" }, "BEST FOR \xB7 LEGACY SMTP \xB7 MINIMIZED PLAINTEXT EXPOSURE"))), /* @__PURE__ */ React.createElement("div", { className: "section-label home-section-label" }, /* @__PURE__ */ React.createElement("span", { className: "index" }, "// 02"), " SECURITY ", /* @__PURE__ */ React.createElement("span", { className: "rule" }), /* @__PURE__ */ React.createElement("span", { className: "tiny dim" }, "MAIL-FIRST ZERO-ACCESS ARCHITECTURE")), /* @__PURE__ */ React.createElement("div", { className: "home-card-grid home-card-grid--four" }, /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// KEYS STAY CLIENT-SIDE"), /* @__PURE__ */ React.createElement("p", null, "Account and identity keys are generated or unlocked in the browser so operators cannot silently read inbox contents.")), /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// CIPHERTEXT AT REST"), /* @__PURE__ */ React.createElement("p", null, "Mailbox bodies and protected-link payloads are stored as encrypted objects, not plaintext rows waiting to leak.")), /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// LOCAL-ONLY SEARCH"), /* @__PURE__ */ React.createElement("p", null, "Body indexing stays on the device, preserving searchability without handing message contents to the backend.")), /* @__PURE__ */ React.createElement("article", { className: "home-card" }, /* @__PURE__ */ React.createElement("h4", null, "// OPEN STANDARDS"), /* @__PURE__ */ React.createElement("p", null, "OpenPGP import/export, SMTP delivery, and publishable public keys keep the system interoperable instead of walled off."))), /* @__PURE__ */ React.createElement("div", { className: "section-label home-section-label" }, /* @__PURE__ */ React.createElement("span", { className: "index" }, "// 03"), " PROTOCOL ", /* @__PURE__ */ React.createElement("span", { className: "rule" }), /* @__PURE__ */ React.createElement("span", { className: "tiny dim" }, "TRUST SIGNALS")), /* @__PURE__ */ React.createElement("div", { className: "home-protocol-grid" }, /* @__PURE__ */ React.createElement("div", { className: "home-stats-grid" }, /* @__PURE__ */ React.createElement("div", { className: "home-stat" }, /* @__PURE__ */ React.createElement("div", { className: "home-stat-key" }, "ENCRYPTION"), /* @__PURE__ */ React.createElement("div", { className: "home-stat-value" }, "OPENPGP")), /* @__PURE__ */ React.createElement("div", { className: "home-stat" }, /* @__PURE__ */ React.createElement("div", { className: "home-stat-key" }, "KEYS"), /* @__PURE__ */ React.createElement("div", { className: "home-stat-value" }, "BROWSER-HELD")), /* @__PURE__ */ React.createElement("div", { className: "home-stat" }, /* @__PURE__ */ React.createElement("div", { className: "home-stat-key" }, "DELIVERY"), /* @__PURE__ */ React.createElement("div", { className: "home-stat-value" }, "SMTP + LINK")), /* @__PURE__ */ React.createElement("div", { className: "home-stat" }, /* @__PURE__ */ React.createElement("div", { className: "home-stat-key" }, "STORAGE"), /* @__PURE__ */ React.createElement("div", { className: "home-stat-value" }, "CIPHERTEXT"))), /* @__PURE__ */ React.createElement("aside", { className: "home-callout bracket", "aria-label": "Why ELVISH mail exists" }, /* @__PURE__ */ React.createElement("span", { className: "br-bl" }), /* @__PURE__ */ React.createElement("span", { className: "br-br" }), /* @__PURE__ */ React.createElement("div", { className: "ftk" }, "// WHY ELVISH"), /* @__PURE__ */ React.createElement("p", null, "Plain email asks you to trust every provider in the path with message content. ELVISH moves encryption decisions to the browser so storage, queues, and relays handle protected payloads instead of readable mail."))), /* @__PURE__ */ React.createElement("div", { className: "stripe-band" }), /* @__PURE__ */ React.createElement("div", { className: "ticker", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "ticker-track" }, /* @__PURE__ */ React.createElement("span", null, "E2EE BY DEFAULT"), /* @__PURE__ */ React.createElement("span", null, "BROWSER-HELD KEYS"), /* @__PURE__ */ React.createElement("span", null, "ZERO-ACCESS STORAGE"), /* @__PURE__ */ React.createElement("span", null, "OPENPGP COMPATIBLE"), /* @__PURE__ */ React.createElement("span", null, "PROTECTED LINKS"), /* @__PURE__ */ React.createElement("span", null, "PLAINTEXT RELAY"), /* @__PURE__ */ React.createElement("span", null, "OPEN SOURCE"), /* @__PURE__ */ React.createElement("span", null, "AGPL-3.0"), /* @__PURE__ */ React.createElement("span", null, "ELVISH MAIL"), /* @__PURE__ */ React.createElement("span", null, "E2EE BY DEFAULT"), /* @__PURE__ */ React.createElement("span", null, "BROWSER-HELD KEYS"), /* @__PURE__ */ React.createElement("span", null, "ZERO-ACCESS STORAGE"), /* @__PURE__ */ React.createElement("span", null, "OPENPGP COMPATIBLE"), /* @__PURE__ */ React.createElement("span", null, "PROTECTED LINKS"), /* @__PURE__ */ React.createElement("span", null, "PLAINTEXT RELAY"), /* @__PURE__ */ React.createElement("span", null, "OPEN SOURCE"), /* @__PURE__ */ React.createElement("span", null, "AGPL-3.0"), /* @__PURE__ */ React.createElement("span", null, "ELVISH MAIL"))), /* @__PURE__ */ React.createElement(Footer, null), konami && /* @__PURE__ */ React.createElement("div", { className: "konami-toast" }, "DEV MODE ENGAGED \xB7 WELCOME, FRIEND"), /* @__PURE__ */ React.createElement(window.TweaksPanel, { title: "TWEAKS" }, /* @__PURE__ */ React.createElement(window.TweakSection, { title: "Appearance" }, /* @__PURE__ */ React.createElement(
      window.TweakRadio,
      {
        label: "Theme",
        value: tweak.theme,
  ...
  require_admin_tools_preview_entry();
})();
