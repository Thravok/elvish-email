// Command apiroutes merges libs/go/httpserver/api.go literal routes with
// docs/openapi/supplemental.yaml and writes libs/go/apidoc/openapi.yaml.
package main
...
func main() {
	write := flag.Bool("write", false, "write libs/go/apidoc/openapi.yaml")
